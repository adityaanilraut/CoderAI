...
class LazySubcommandGroup(typer.core.TyperGroup):
    ...
    lazy_subcommands: dict[str, tuple[str, str, str]] = {
        "info": ("coderai.cli.info", "cli", "Show version and protocol information."),
        "export": ("coderai.cli.export", "cli", "Export session data."),
        "mcp": ("coderai.cli.mcp", "cli", "Manage MCP server configurations."),
        "plugin": ("coderai.cli.plugin", "cli", "Manage plugins."),
    }
