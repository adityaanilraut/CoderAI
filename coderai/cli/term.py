...
def restore_cursor() -> None:
    """Ensure terminal cursor is visible and flushed."""
    try:
...
def ensure_new_line() -> None:
    """Ensure next prompt starts at column 0 regardless of prior output."""
...
def ensure_tty_sane() -> None:
    """Restore basic tty settings and cursor visibility so Ctrl-C works after raw-mode."""
    restore_cursor()
