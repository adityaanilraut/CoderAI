...
def resolve_color_system() -> str | None:
    """Graceful fallback: honor NO_COLOR / non-truecolor terms (ponytail: env sniff)."""
    try:
        from coderai.cli.theme import get_color_system

        return get_color_system()
    except Exception:
        return None
