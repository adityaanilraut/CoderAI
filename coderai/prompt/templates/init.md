...
After the exploration, you should do a thorough summary of your findings and write or update `AGENTS.md` file in the project root. You need to refer to what is already in the file when you do so.
