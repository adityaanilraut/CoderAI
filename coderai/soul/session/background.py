...
from coderai.utils.path import read_text_file_tail
from coderai.soul.session.models import _now
from coderai.tools.legacy.types import BackgroundProcessCompletion
...
def maybe_notify_task_completion(manager: Any, session_id: str, started_at_ms: int) -> None:
    ...
    from coderai.utils.common.notify import launch_notify_script
