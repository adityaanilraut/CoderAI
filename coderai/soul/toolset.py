...
class CoderAIToolset:
    ...
    def load_tools(self, tool_paths: list[str], dependencies: dict[type[Any], Any]) -> None:
        ...
        Raises:
            InvalidToolError(CoderAIException, ValueError): When any tool cannot be loaded.
        """
    ...
    async def load_mcp_tools(
        ...
        Raises:
            MCPRuntimeError(CoderAIException, RuntimeError): When any MCP server cannot be
                connected.
        """
        import fastmcp
        from fastmcp.mcp_config import MCPConfig, RemoteMCPServer

        from coderai.mcp_oauth import create_mcp_oauth, has_mcp_oauth_tokens
