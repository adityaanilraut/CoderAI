...
from coderai.notifications.llm import is_notification_message
from coderai.soul.message import is_system_reminder_message
from coderai.ui.shell.console import console
from coderai.ui.shell.echo import render_user_echo
from coderai.ui.shell.visualize import visualize
from coderai.utils.aioqueue import QueueShutDown
from coderai.utils.logging import logger
from coderai.utils.message import message_stringify
from coderai.utils.slashcmd import parse_slash_command_call
    ...
    for message in history:
        if _is_user_message(message):
            ...
            for part in message.content:
                if hasattr(part, "text") and not isinstance(part, TextPart):
                    current_turn.events.append(TextPart(text=part.text))
                else:
                    current_turn.events.append(part)
