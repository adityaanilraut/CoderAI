...
from coderai.ui.shell.echo import render_user_echo_text
from coderai.ui.shell.keyboard import KeyEvent
from coderai.ui.shell.prompt import (
    CustomPromptSession,
    UserInput,
)
from coderai.ui.shell.visualize._btw_panel import _BtwModalDelegate
from coderai.ui.shell.visualize._input_router import InputAction, classify_input
from coderai.ui.shell.visualize._live_view import _LiveView
        ...
        match action.kind:
            ...
            case InputAction.QUEUE:
                ...
                if cmd := parse_slash_command_call(user_input.resolved_command.strip()):
                    from coderai.ui.shell.slash import registry as shell_registry
